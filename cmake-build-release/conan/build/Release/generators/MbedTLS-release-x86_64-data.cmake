...
########### VARIABLES #######################################################################
#############################################################################################
set(mbedtls_PACKAGE_FOLDER_RELEASE "C:/Users/ast12/.conan2/p/mbedtd10c28e70aaf4/p")
set(mbedtls_BUILD_MODULES_PATHS_RELEASE )


set(mbedtls_INCLUDE_DIRS_RELEASE )
...
set(mbedtls_LIB_DIRS_RELEASE "${mbedtls_PACKAGE_FOLDER_RELEASE}/lib")
set(mbedtls_BIN_DIRS_RELEASE )
set(mbedtls_LIBRARY_TYPE_RELEASE STATIC)
set(mbedtls_IS_HOST_WINDOWS_RELEASE 1)
...
set(mbedtls_MbedTLS_mbedtls_INCLUDE_DIRS_RELEASE )
set(mbedtls_MbedTLS_mbedtls_LIB_DIRS_RELEASE "${mbedtls_PACKAGE_FOLDER_RELEASE}/lib")
set(mbedtls_MbedTLS_mbedtls_BIN_DIRS_RELEASE )
set(mbedtls_MbedTLS_mbedtls_LIBRARY_TYPE_RELEASE STATIC)
set(mbedtls_MbedTLS_mbedtls_IS_HOST_WINDOWS_RELEASE 1)
...
set(mbedtls_MbedTLS_mbedtls_DEPENDENCIES_RELEASE MbedTLS::mbedx509 ZLIB::ZLIB)
...
set(mbedtls_MbedTLS_mbedx509_INCLUDE_DIRS_RELEASE )
set(mbedtls_MbedTLS_mbedx509_LIB_DIRS_RELEASE "${mbedtls_PACKAGE_FOLDER_RELEASE}/lib")
set(mbedtls_MbedTLS_mbedx509_BIN_DIRS_RELEASE )
set(mbedtls_MbedTLS_mbedx509_LIBRARY_TYPE_RELEASE STATIC)
set(mbedtls_MbedTLS_mbedx509_IS_HOST_WINDOWS_RELEASE 1)
...
set(mbedtls_MbedTLS_mbedx509_DEPENDENCIES_RELEASE MbedTLS::mbedcrypto ZLIB::ZLIB)
...
set(mbedtls_MbedTLS_mbedcrypto_INCLUDE_DIRS_RELEASE )
set(mbedtls_MbedTLS_mbedcrypto_LIB_DIRS_RELEASE "${mbedtls_PACKAGE_FOLDER_RELEASE}/lib")
set(mbedtls_MbedTLS_mbedcrypto_BIN_DIRS_RELEASE )
set(mbedtls_MbedTLS_mbedcrypto_LIBRARY_TYPE_RELEASE STATIC)
set(mbedtls_MbedTLS_mbedcrypto_IS_HOST_WINDOWS_RELEASE 1)
...
set(mbedtls_MbedTLS_mbedcrypto_DEPENDENCIES_RELEASE ZLIB::ZLIB)
